...
from crunch.eyetracker.measurements.information_processing_index import \
    compute_information_processing_index as compute_ipi
from crunch.eyetracker.measurements.information_processing_index import \
    compute_ipi_thresholds as compute_thresholds
